    ...
    <div className="flex min-h-[calc(100vh-4rem)] items-center justify-center px-4">
      <div className="w-full max-w-sm animate-fade-in">
        <div className="mb-8 text-center">
          <div className="mx-auto mb-3 flex h-12 w-12 items-center justify-center rounded-xl bg-replit-accent">
            <Code2 className="h-6 w-6 text-white" />
          </div>
          <h1 className="text-2xl font-bold text-replit-text">Welcome back</h1>
        ...
        <div className="relative mb-4">
          <div className="absolute inset-0 flex items-center"><div className="w-full border-t border-replit-border" /></div>
          <div className="relative flex justify-center"><span className="bg-replit-bg px-3 text-xs text-replit-muted">or</span></div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="relative">
            ...
            <button type="button" onClick={() => setShowPw(!showPw)} className="absolute right-3 top-1/2 -translate-y-1/2 text-replit-muted hover:text-replit-text">
        ...
        <p className="mt-4 text-center text-sm text-replit-muted">
          Don&apos;t have an account?{" "}
          <Link href="/signup" className="text-replit-accent hover:text-replit-accent-hover font-medium">Sign Up</Link>
        </p>
      </div>
    </div>
  )
